...
This repo includes working demo scripts — see the [`/examples`](./examples) directory:

| File | Description |
|------|-------------|
| `examples/chat.py` | Basic chat completion in Python |
| `examples/openai_sdk.py` | Using the official OpenAI SDK |
| `examples/stream.py` | Streaming responses |
| `examples/chat.sh` | Bash/curl one-liner |
